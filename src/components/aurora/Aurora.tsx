...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uOpacity.value = propsRef.current.opacity ?? 1.0;
      const stops = propsRef.current.colorStops || [
        propsRef.current.color1 || '#5227FF',
        propsRef.current.color2 || '#7cff67',
        propsRef.current.color3 || '#5227FF'
      ];
