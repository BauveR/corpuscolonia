      ...
      <AnimatePresence>
        {mobileOpen && (
          <>
            ...
            />
            <motion.aside
              className="fixed left-0 top-0 z-50 h-[100dvh] w-[86vw] max-w-[270px] bg-gradient-to-r from-[oklch(40.8%_0.123_38.172/0.8)] to-transparent text-stone-200 shadow-xl p-4"
