    ...
    <GlassPanel variants={containerVariants} className="h-full">
      ...
      <div className="ms-4 sm:ms-8 mt-4 space-y-4 text-sm text-slate-400">
        ...
        <div className="pt-4 mt-4 border-t border-white/10 space-y-2">
          <p className="font-bold text-stone-200 text-sm">Stack: React, JavaScript, HTML5, CSS3, Git</p>
          <p className="text-orange-400 text-sm">📍 Barcelona</p>
          <p className="text-slate-400 text-sm">
            🔍 <span className="font-bold text-stone-200">Busco:</span> Frontend Developer Junior, Product Owner Junior, Digital Project Manager o Business Analyst donde mi expertise en diseño de productos, visión de negocio y conocimientos técnicos generen valor real.
          </p>
        </div>
      </div>
    </GlassPanel>
