  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center py-16 pb-[20rem] gap-0 relative">
        ...
        <div className={[
          "relative z-10 flex flex-col md:flex-row items-center gap-4 md:gap-6 px-4 md:px-8 py-5 md:py-6 mx-auto w-[92%] md:w-[70%] lg:w-[55%]",
          ...
          {/* Video */}
          <div className="w-full md:flex-1 rounded-2xl overflow-hidden aspect-video">
            <iframe
          ...
          <div className="flex flex-row md:flex-col items-center justify-center gap-4 md:gap-3 flex-shrink-0 py-2 md:py-0">
